...
function iniciaMascara() {
    ...
    $(".valor").each(function (key, value) {
        ...
        $(this).blur(function () { Mascara(this, Valor); });
    });
...
function validaCampos() {
    ...
    if (!ok) {
        $(".divErro").show();
        $(".divErro").html("&Eacute; obrigat&oacute;rio o preenchimento dos campos em vermelho.");
    }
